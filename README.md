...
- **Analyses**  
  ...
  Notes: `/src/dataloader_dtd.py` and `/src/dataloader_gaussian.py` contain two dataloaders as a standard pipeline to deal with data in PyTorch and Torchvision.  
